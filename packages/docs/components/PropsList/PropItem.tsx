...
const PrropItem: FC<Prop> = ({
  ...
  <div className="text-md flex flex-col font-mono">
    ...
    <div className="space-y-1">
      <p className="flex flex-row items-center m-0 space-x-10">
        ...
        <span className=" text-primary-500 px-4 py-1">{type}</span>
      </p>
      {description && (
        <p className="flex flex-row items-center m-0 space-x-10">
          <strong className="w-32">Description</strong>
          <span className="px-4 py-1 font-sans">{description}</span>
        </p>
      )}
      {defaultValue && (
        <p className="flex flex-row items-center m-0 space-x-10">
          <strong className="w-32">Default</strong>
          <span className="px-4 py-1">{defaultValue}</span>
        </p>
      )}
    </div>
  </div>
