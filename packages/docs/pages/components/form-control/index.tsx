...
const FormControlPage: FC<IFormControl> = () => {
  ...
  return (
    <Page
      ...
      description={
        <>
          <Keyword>FormControl</Keyword> component consists of label, hint text
          and an error message. In case <Keyword>error</Keyword> property is
          populated, hint message won{"'"}t showup even if the{" "}
