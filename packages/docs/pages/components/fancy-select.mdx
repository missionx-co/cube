...
import { FancySelect, Input } from '@cube/components';
  ...
  <FancySelect
    options={[
      ...
      },
      {
        ...
        children: [
          {
            value: 'north-america-2',
            text: 'North America',
          },
          {
            value: 'middle-america-2',
            text: 'Middle America',
          },
          {
            value: 'south-america-2',
            text: 'South America',
          },
        ],
      },
      {
        ...
        children: [
          {
            value: 'north-america-3',
            text: 'North America',
          },
          {
            value: 'middle-america-3',
            text: 'Middle America',
          },
          {
            value: 'south-america-3',
            text: 'South America',
          },
        ],
      },
