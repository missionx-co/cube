...
export const primary = [
  ...
  },
  {
    ...
    variant: "link",
    css: {
      ...tw`p-0 border-0 text-primary-700 hover:text-primary-800 disabled:text-gray-300`,
    },
  },
];
...
export const error = [
  ...
  },
  {
    ...
    variant: "link",
    css: {
      ...tw`p-0 border-0 text-error-700 hover:text-error-800 disabled:text-error-300`,
    },
  },
];
